 ...
 */
defined( 'ENHANCED_AJAX_ADD_TO_CART' ) || define( 'ENHANCED_AJAX_ADD_TO_CART', '2.3.1-next' );
defined( 'EAA2C_PLUGIN_FILE' ) || define( 'EAA2C_PLUGIN_FILE', __FILE__ );

/**
 * The code that runs during plugin activation.
 * This action is documented in includes/class-eaa2c-activator.php
 */
if ( ! function_exists( 'activate_enhanced_ajax_add_to_cart_wc' ) ) {
	function activate_enhanced_ajax_add_to_cart_wc() {
		require_once plugin_dir_path( __FILE__ ) . 'includes/class-eaa2c-activator.php';
 ...
 * This action is documented in includes/class-eaa2c-deactivator.php
 */
if ( ! function_exists( 'deactivate_enhanced_ajax_add_to_cart_wc' ) ) {
	function deactivate_enhanced_ajax_add_to_cart_wc() {
		require_once plugin_dir_path( __FILE__ ) . 'includes/class-eaa2c-deactivator.php';
...
if ( ! class_exists( 'Enhanced_Ajax_Add_To_Cart_Wc' ) ) {
	include_once dirname( EAA2C_PLUGIN_FILE ) . '/includes/class-enhanced-ajax-add-to-cart-wc.php';
}
